...
# TODO use a tamper-proof (signed) cookie
# Taken from: http://appengine-cookbook.appspot.com/recipe/a-simple-cookie-class
class Cookies(UserDict.DictMixin):
    ...
    def set_cookie(self, key, value='', max_age=None,
        ...
        for var_name, var_value in [
            ...
            if max_age is None:
                max_age = 315360000 # Equals 60 * 60 * 24 * 365 * 10
